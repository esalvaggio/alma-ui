...
const InlineCard = memo(({ answered, cardData, handleCardAnswer, setAnswered }: {
    answered: boolean,
    cardData: CardData,
    ...
    return (
        <div className={style.cardGroup}>
            <>
                <div className={`${style.card} ${style.mainCard} ${style.inline} ${!answered && style.cardUnanswered}`} onClick={() => setAnswered(true)}>
...
const ReviewCard = memo(({ answered, cardData, handleCardAnswer, setAnswered }: {
    answered: boolean,
    cardData: CardData,
    handleCardAnswer: (correct: boolean) => void,
    setAnswered: (value: boolean) => void
    ...
    return (
        <div className={style.cardGroup}>
            <>
                <div className={`${style.card} ${style.mainCard} ${style.review} ${!answered && style.cardUnanswered}`} onClick={() => setAnswered(true)}>
                    <div className={style.cardContent}>
                        <h1 className={style.questionText}>{cardData.question}</h1>
                        <div className={style.contentWrapper}>
                            {!answered ? (
